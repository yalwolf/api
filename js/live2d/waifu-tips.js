...
function ifActed() {
    if (!hitokotoInterval) {
        ...
        hitokotoTimer = window.setInterval(showHitokoto, 3000);
    }
}
...
function initModel(waifuPath){
	...
	$.ajax({
        cache: true,
        url:'https://cdn.jsdelivr.net/gh/qiuliqi/live2d/waifu-tips.json',
        dataType: "json",
...
function loadModel(modelId, modelTexturesId){
   ...
   // localStorage.setItem('modelTexturesId', modelTexturesId);
    loadlive2d('live2d','https://cdn.jsdelivr.net/gh/qiuliqi/live2d@1.0/model.json'/*'https://api.fghrsh.net/live2d/get/?id='+modelId+'-'+modelTexturesId*/, console.log('live2d','模型 '+modelId+'-'+modelTexturesId+' 加载完成'));
}
